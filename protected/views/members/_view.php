<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('github')); ?>:</b>
	<?php echo CHtml::encode($data->github); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('yii_profile')); ?>:</b>
	<?php echo CHtml::encode($data->yii_profile); ?>
	<br />
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('is_subscribed')); ?>:</b>
	<?php echo CHtml::encode($data->is_subscribed); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('is_blocked')); ?>:</b>
	<?php echo CHtml::encode($data->is_blocked); ?>
	<br />
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('active_key')); ?>:</b>
	<?php echo CHtml::encode($data->active_key); ?>
	<br />
