...
<?php echo $form->textFieldRow($model, 'user_name', array('class' => 'span5', 'maxlength' => 256, 'disabled' => true)); ?>

<?php echo $form->textFieldRow($model, 'email', array('class' => 'span5', 'maxlength' => 256, 'disabled' => true)); ?>
...
<?php echo $form->textFieldRow($model, 'website', array('class' => 'span5', 'maxlength' => 100, 'hint' => 'example http://yourdomains.com')); ?>
...
<?php echo $form->toggleButtonRow($model, 'is_subscribed', array('class' => 'span5', 'maxlength' => 1, 'hint' => 'Send me email alerts')); ?>
