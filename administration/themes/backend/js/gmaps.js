/* [ ---- Gebo Admin Panel - location finder ---- ] */
    ...
    tolodo_maps = {
        init: function() {
            tolodo_maps.create();
            tolodo_maps.save_location();
            tolodo_maps.edit_location();
            tolodo_maps.show_location();
        ...
        create: function() {
            ...
            g_Map.gmap3({
                ...
                callback: function(){
                    $('#gmap_search_btn').on('click', function(){
                       location_add_form.find('input').val('');
                       tolodo_maps.drop_marker_search();
                       return false;
                    })
                }
            });
