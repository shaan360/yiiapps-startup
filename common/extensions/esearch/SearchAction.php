...
class SearchAction extends CAction {
	...
	public function init() {
		...
		if ($this->view === null) {
			$this->viewPath = 'common.extensions.esearch.views.';
			$this->view = 'results';
	...
	public static function renderInputBox($options=array()) {
		extract(array_merge(array('url' => array('site/search'), 'htmlOptions' => array(), 'view' => 'common.extensions.esearch.views.inputBox'), $options));
		if (!isset($htmlOptions['class']))
			$htmlOptions['class'] = 'search';
		if (!isset($htmlOptions['label']))
			$htmlOptions['label'] = Yii::t('app', 'Search');
