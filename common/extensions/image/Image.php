...
Yii::import('common.extensions.image.CArray');
Yii::import('common.extensions.image.Image_Driver');
...
class Image {
	...
	public function __construct($image, $config = NULL)
	{
        ...
        // Load the driver
        Yii::import("common.extensions.image.drivers.$driver");
	...
	public function colorize($hex,$overlay=false)
	{
		$this->actions['colorize'] = array('color' => $hex, 'overlay' => $overlay);
		return $this;
	}
