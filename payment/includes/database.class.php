...
var $user     = "gorentco_user"; //database login name
var $pass     = "gorentco"; //database login password
var $database = "gorentco_newdatabase"; //database name
...
function oops($msg='') {
    if($this->link_id>0){
        ...
        if(strlen($this->error)>0)
			$email_body .= '<tr><td align="right" valign="top" nowrap>MySQL Error:</td><td>' . $this->error . '</tr></td>';
		...
		array_push($this -> errors, $email_body);
